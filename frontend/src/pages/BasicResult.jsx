...
export default function BasicResult() {
  ...
  const calculationResult = location.state;
    ...
    <PageConainer>
      ...
      <div className="flex flex-col items-center justify-center p-4">
        ...
        <div className="bg-green-lightest p-3 rounded rounded-lg flex justify-center items-center">
          ...
          <p className="p-3 data-big text-xl">
            i
          </p>

          <p className="p-3">
            Este resultado es gratis y completo. Si querés
            comparar escenarios, el breakdown por capa y el
            PDF descargable, te pedimos tu email a cambio —
            no antes.
          </p>
